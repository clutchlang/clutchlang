...
export class PrintTreeVisitor extends ast.AstVisitor<
  StringBuffer,
  StringBuffer
> {
  ...
  public visitBinaryExpression(
    ...
    return this.visitAll('BinaryExpression', buffer, [
      ['Left', node.left],
  ...
  public visitCallExpression(
    ...
    return this.visitAll('CallExpression', buffer, [
      ['Target', node.target],
      ['Arguments', node.args],
    ]);
  }
  ...
  public visitConditionalExpression(
    ...
    return this.visitAll('ConditionalExpression', buffer, [
      ['If', node.condition],
      ['Then', node.body],
      ['Else', node.elseBody],
    ]);
  ...
  public visitFunctionDeclaration(
    ...
    return this.visitAll('FunctionDeclaration', buffer, [
      ['Name', node.name],
  ...
  public visitGroupExpression(
    ...
    return this.visitAll('GroupExpression', buffer, [
  ...
  public visitIdentifier(
    ...
    return this.visitAll(`Identifier {${node.name}}`, buffer);
  }
  ...
  public visitLiteralBoolean(
    ...
    return this.visitAll(`LiteralBoolean {${node.value}}`, buffer);
  }
  ...
  public visitLiteralNumber(
    ...
    return this.visitAll(`LiteralNumber {${node.value}}`, buffer);
  }
  ...
  public visitLiteralString(
    ...
    return this.visitAll(`LiteralString {${node.value}}`, buffer);
  }
  ...
  public visitModuleDeclaration(
    ...
    return this.visitAll(`ModuleDeclaration`, buffer, [
  ...
  public visitModuleRoot(
    ...
    return this.visitAll(`ModuleRoot`, buffer, [['Modules', node.modules]]);
  }
  ...
  public visitParameterList(
    ...
    return this.visitAll(`ParameterList`, buffer, [
      ['Parameters', node.params],
    ]);
  }
  ...
  public visitPrefixExpression(
    ...
    return this.visitAll(`PrefixExpression`, buffer, [
      ['Operator', node.operator],
      ['Target', node.target],
    ]);
  }
  ...
  public visitPostfixExpression(
    ...
    return this.visitAll(`PostfixExpression`, buffer, [
      ['Target', node.target],
      ['Operator', node.operator],
    ]);
  }
  ...
  public visitPropertyExpression(
    ...
    return this.visitAll(`PropertyExpression`, buffer, [
      ['Target', node.target],
  ...
  public visitReturnStatement(
    ...
    return this.visitAll(`ReturnStatement`, buffer, [
      ['Expression', node.expression],
    ]);
  }
  ...
  public visitStatementBlock(
    ...
    return this.visitAll(`StatementBlock`, buffer, [
  ...
  public visitTypeDeclaration(
    ...
    return this.visitAll(`TypeDeclaration`, buffer, [
      ['Name', node.name],
      ['External', node.isExternal],
  ...
  public visitVariableDeclaration(
    ...
    return this.visitAll(`VariableDeclaration`, buffer, [
      ['Name', node.name],
      ['Type', node.type],
      ['Value', node.value],
    ]);
  ...
  private visitAll(
    ...
    children: ReadonlyArray<
      [string, ast.AstNode | ast.AstNode[] | undefined | boolean | string]
    > = []
  ): StringBuffer {
